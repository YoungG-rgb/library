...
- **Входящий id недоверенный** — валидируй формат (UUID) или генери свой. Не принимай произвольную строку.
...
public enum CorrelationHeader {
    ...
    /** safe-charset + лимит длины: защита от мусора / high-cardinality. Не строгий UUID —
        иначе не-UUID id из внешних систем отбрасывались бы, рвя корреляцию. */
